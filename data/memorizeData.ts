export const ROMANS_8_MEMORIZE_WORDS: string[][] = [
  // Verse 1
  ...
  [
    "That’s why",
    "those who are still under the control of their sinful nature",
  ...
  [
    ...
    "(And remember",
    "that those who do not have the Spirit of Christ living in them",
  ...
  [
    ...
    "by this same Spirit living in you"
  ],
  // Verse 12
  [
  ...
  [
    ...
    "for the day when God will give us our full rights",
  ...
  [
    ...
    "we don’t need to hope for it)"
  ],
  // Verse 25
  [
    "But if we look forward to something",
    "we don’t yet have,",
